...
public class Day1_4 {
	...
	public void setUp()
	{
		System.setProperty("webdriver.driver.chromeDriver", "C://Users//Yogesh//git//NewPractice//NewChromeDriver//chromedriver.exe");
	...
	public void tc3() throws InterruptedException
	{
		...
		System.out.println("Total Number Autosuggestion :"+noAuto);
		...
		for(WebElement autoT:auto)
		{
			...
			if(autoText.contentEquals("Seychelles"))
			{
				autoT.click();
	...
	{
		String expected="https://www.dot-consulting.org/articles/foundations-of-modern-higher-education.html?psystem=PW&domain=www.qaclickacademy.com&oref=https%3A%2F%2Fwww.qaclickacademy.com%2F&trafficTarget=reseller";
