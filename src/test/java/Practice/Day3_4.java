...
public class Day3_4 {
	...
	{
		String expected="Wallis and Futuna Islands";
		...
		for(WebElement autoT:auto)
		{
			...
			if(autoTxt.contentEquals("Wallis and Futuna Islands"))
			{
				autoT.click();
