...
public class Day24_3 {
	...
	public void tc1()
	{
		...
		System.out.println("Total Tag are :"+noTag);
	...
	public void tc2()
	{
		...
		screenShot("24_3RADIO");
	}
	
	@Test
	public void tc3() throws InterruptedException
	{
		String expected="United Arab Emirates";
		...
		{
			String autoTxxt=autoT.getText();
			
			System.out.println("Autosuggestion are :"+autoTxxt);
			
			if(autoTxxt.contentEquals("United Arab Emirates"))
			{
				autoT.click();
