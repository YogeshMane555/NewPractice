...
public class Day13_9 {
	...
	public void tc1()
	{
		...
		System.out.println("Number of Tags are :"+noTags);
		
		for(WebElement tagsTxt:tags)
		{
			String tgtxt=tagsTxt.getText();
	...
	public void tc2()
	{
		...
		try {
			FileUtils.copyFile(src2, new File("C://Users//Yogesh//git//NewPractice//Screenshot//13_9RADIOBUTTON.png"));
		} catch (IOException e) {
	...
	{
		WebElement autoTextBox=km.findElement(By.xpath("//input[contains(@id,'autocomplete')]"));
		
		autoTextBox.sendKeys("We");
		...
		for(WebElement autot:auto)
		{
			...
			if(autotxt.contentEquals("Zimbabwe"))
			{
				autot.click();
			}
		}
		...
		try {
			FileUtils.copyFile(src3, new File("C://Users//Yogesh//git//NewPractice//Screenshot//13_9AutoSuggestion.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void tc4()
	{
		...
		try {
			FileUtils.copyFile(src4, new File("C://Users//Yogesh//git//NewPractice//Screenshot//13_9DROPDOWN.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void tc5()
	{
		...
		try {
			FileUtils.copyFile(src5, new File("C://Users//Yogesh//git//NewPractice//Screenshot//13_9CHECKBOX.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void tc6() throws InterruptedException
	{
		...
		km.findElement(By.xpath("//a[contains(text(),'Learn More')]")).click();
		...
		try {
			FileUtils.copyFile(src6, new File("C://Users//Yogesh//git//NewPractice//Screenshot//13_9NEWTAB.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void tc8() throws InterruptedException
	{
		...
		WebElement displayText=km.findElement(By.xpath("//input[contains(@id,'displayed-text')]"));
		
		displayText.sendKeys("TEXTBOX DISPLAYED  ?");
		
		km.findElement(By.xpath("//input[contains(@id,'hide-textbox')]")).click();
		
		boolean b8=displayText.isDisplayed();
		
		System.out.println("Textbox displayed ?:"+b8);
		...
		try {
			FileUtils.copyFile(src8, new File("C://Users//Yogesh//git//NewPractice//Screenshot//13_9AfterClickingHIDEButton.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		boolean b9=displayText.isDisplayed();
		
		System.out.println("Textbox displayed After Cliking Show Button ?:"+b9);
		...
		try {
			FileUtils.copyFile(src9, new File("C://Users//Yogesh//git//NewPractice//Screenshot//13_9AfterClickingSHOWButton.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void tc9() throws InterruptedException
	{
		...
		js10.executeScript("window.scrollBy(0,900)");
		...
		try {
			FileUtils.copyFile(src10, new File("C://Users//Yogesh//git//NewPractice//Screenshot//13_9FRAME.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void tc10() throws InterruptedException
	{
		...
		try {
			FileUtils.copyFile(src11, new File("C://Users//Yogesh//git//NewPractice//Screenshot//13_9ACTIONS.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
