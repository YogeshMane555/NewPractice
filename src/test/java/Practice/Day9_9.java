...
public class Day9_9 {
	...
	public void tc1() {
		...
		System.out.println("Total Number of Tags are :" + tgno);

		for (WebElement tgt : tg) {
			String textName = tgt.getText();

			System.out.println("Tags are :" + textName);
		}
		...
		System.out.println("URL og WebPage is :" + url);
		
		WebElement txtTitle=km.findElement(By.xpath("//h1[contains(text(),'Practice Page')]"));
		
		String webTitle=txtTitle.getText();
		
		System.out.println("Title Webpage :"+webTitle);
	}
	...
	public void tc2() {
		...
		System.out.println("Is Radio button 1 Selected ?:" + b1);
		...
		try {
			FileUtils.copyFile(src2, new File("C://Users//Yogesh//git//NewPractice//Screenshot//9_9RadioButon.png"));
		} catch (IOException e) {
	...
	public void tc3() throws InterruptedException {
		WebElement autosugg=km.findElement(By.xpath("//input[contains(@id,'autocomplete')]"));
		
		autosugg.sendKeys("Sa");
		...
		for (WebElement autotxt : auto) {
			String txtt = autotxt.getText();

			System.out.println("Autosuggestions are :" + txtt);

			if (txtt.contentEquals("Saudi Arabia")) {
				autotxt.click();
			}
		}
		...
		try {
			FileUtils.copyFile(src3,
					new File("C://Users//Yogesh//git//NewPractice//Screenshot//9_9AutoSuggestion.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void tc4() {
		...
		try {
			FileUtils.copyFile(src4, new File("C://Users//Yogesh//git//NewPractice//Screenshot//9_9DropDown.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void tc5() {
		...
		System.out.println("Is checkbox 1 Selected ?:" + b5);
		...
		try {
			FileUtils.copyFile(src5, new File("C://Users//Yogesh//git//NewPractice//Screenshot//9_9CheckBox.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void tc6() throws InterruptedException {
		...
		try {
			FileUtils.copyFile(src6, new File("C://Users//Yogesh//git//NewPractice//Screenshot//9_9NewTab.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void tc7() throws InterruptedException {
		...
		txt.sendKeys("YOGESHWAR MAHARAJ");
		...
		txt.sendKeys("MANESHWAR MAHARAJ");
	...
	public void tc8() throws InterruptedException {
		...
		WebElement TextElement = km.findElement(By.xpath("//input[contains(@id,'displayed-text')]"));

		TextElement.sendKeys("KESHVAY NAMAH");

		Thread.sleep(2000);

		km.findElement(By.xpath("//input[contains(@id,'hide-textbox')]")).click();

		boolean b9 = TextElement.isDisplayed();

		System.out.println("After Clicking on Hide button is TextBox Displayed ?:" + b9);
		...
		try {
			FileUtils.copyFile(src8, new File("C://Users//Yogesh//git//NewPractice//Screenshot//9_9HideButton.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		boolean b8 = TextElement.isDisplayed();

		System.out.println("After Clicking on Show button is TextBox Displayed ?:" + b8);
		...
		try {
			FileUtils.copyFile(src9, new File("C://Users//Yogesh//git//NewPractice//Screenshot//9_9ShowButton.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void tc9() throws InterruptedException {
		...
		JavascriptExecutor j10 = (JavascriptExecutor) km;

		j10.executeScript("window.scrollBy(0,1000)");
		...
		try {
			FileUtils.copyFile(src10, new File("C://Users//Yogesh//git//NewPractice//Screenshot//9_9Frame.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void tc10() {
		...
		aa.moveToElement(mouseHover).build().perform();
		...
		try {
			FileUtils.copyFile(src11, new File("C://Users//Yogesh//git//NewPractice//Screenshot//9_9Actions.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
