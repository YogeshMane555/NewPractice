...
public class Day6_3 {
	...
	public void tc3() throws InterruptedException
	{
		...
		for(WebElement autoT:auto)	
		{
			...
			if(autoTxt.contentEquals("Myanmar"))
			{
				autoT.click();
				
				String actual=sugTxt.getAttribute("value");
				
				System.out.println("Selected from Autosuggestions are :"+actual);
				
				Assert.assertEquals(actual, expected);
				
				screenShot("6_3Autosuggestion");
			}
		}
	}
