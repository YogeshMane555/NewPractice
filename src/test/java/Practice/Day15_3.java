...
public class Day15_3 {
	...
	public void tc1()
	{
		...
		for(WebElement tgT:tg)
		{
			...
			System.out.println("Tag are :"+tagText);
		}
	}
	...
	public void tc2()
	{
		...
		screenShot("15_3RADIO");
	}
	
	@Test
	public void tc3() throws InterruptedException
	{
		String expected="Russian Federation";
		...
		for(WebElement autoTxt:autoT)
		{
			...
			if(txt.contentEquals("Russian Federation"))
			{
				autoTxt.click();
