...
public class Day20_5 {
	...
	public void tc1()
	{
		...
		System.out.println("Number of Tags are :"+noOfTg);
		
		for(WebElement tgT:tg)
		{
			String Text=tgT.getText();
		
			System.out.println("Number of Text are :"+Text);
		}
	}
	...
	{
		String expected="Papua New Guinea";
		...
		for(WebElement autot:auto)
		{
			...
			if(autoTxt.contains("Papua New Guinea"))
			{
				autot.click();
	...
	public void tc6()
	{
		...
		String acutal=km.getCurrentUrl();
